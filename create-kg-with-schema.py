...
NODE_TYPES = [
    ...
    {"label": "Symptom", "properties": [
        ...
        {"name": "severity", "type": "STRING"}, {"name": "duration", "type": "STRING"}, 
...
PATTERNS = [
    ...
    ("Physician", "WORKS_AT", "Medical Institution"),
...
asyncio.run(kg_builder.run_async(file_path="reports/report11.pdf"))
